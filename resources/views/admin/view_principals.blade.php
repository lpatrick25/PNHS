...
@section('content')
    <div id="toolbar">
        <a href="{{ route('viewAddPrincipal') }}" class="btn btn-primary btn-md btn-block"><i class="fa fa-user-plus"></i> Add
            New</a>
    </div>
    <table id="table" data-show-refresh="true" data-auto-refresh="true" data-pagination="true" data-show-columns="false"
        ...
        <thead>
            <tr>
                ...
                <th data-field="principal_id">PRINCIPAL ID</th>
        ...
        $(document).ready(function() {
            ...
            $table.bootstrapTable({
                ...
                printPageBuilder: function printPageBuilder(table) {
                    return myCustomPrint(table, "List of Principal");
                },
            });
