...
@section('content')
    <form id="addForm" class="card">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-12">
                    <div class="form-group">
                        <label>Principal ID: <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="principal_id" name="principal_id"
                            value="{{ $principalID }}" required>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="card-footer text-right">
            ...
            <a href="{{ route('viewPrincipals') }}" type="button" class="btn btn-danger btn-lg">CANCEL</a>
        </div>
    </form>
@endsection
@section('scripts')
        ...
        function add_another() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = '{{ route('viewPrincipals') }}';
                }
            });
        }
            ...
            $("#addForm").validate({
                rules: {
                    principal_id: {
                        ...
                        remote: {
                            ...
                            data: {
                                username: function() {
                                    return $('#addForm').find('input[id=principal_id]').val();
                                }
                            }
                        }
                    },
                ...
                messages: {
                    principal_id: {
                        ...
                        remote: "Principal ID has already been taken."
                    },
                    firstname: {
